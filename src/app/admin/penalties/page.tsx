      ...
      <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-accent-blue/10 via-accent-purple-1/5 to-transparent p-6 md:p-8">
        ...
        <div className="relative space-y-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge variant="info">Live review queue</Badge>
          </div>
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl">Admin review workspace with seeded booking signals</h2>
